...
edaf80::Assignment3::run()
{
	...
	GLuint const diffuse_texture = bonobo::loadTexture2D(
		config::resources_path("textures/leather_red_02_coll1_2k.jpg"), true
	);
	...
	demo_sphere.add_texture("DiffuseTexture", diffuse_texture, GL_TEXTURE_2D);

	GLuint const specular_texture = bonobo::loadTexture2D(
		config::resources_path("textures/leather_red_02_rough_2k.jpg"), true
	);
	demo_sphere.add_texture("SpecularTexture", specular_texture, GL_TEXTURE_2D);

	GLuint const normal_texture = bonobo::loadTexture2D(
		config::resources_path("textures/leather_red_02_nor_2k.jpg"), true
	);
	demo_sphere.add_texture("NormalTexture", normal_texture, GL_TEXTURE_2D);
